...
def wordy_pyramid():
    ...
    for i in range(3, 20, 2):
        url = f"https://us-central1-waldenpondpress.cloudfunctions.net/give_me_a_word?argName=agVal&wordlength={i}"
...
if __name__ == "__main__":
    ...
    in_root = os.path.isfile("laser.pew")
    in_set4 = os.path.isfile("set4/laser.pew")
    if not in_set4 and not in_root:
        print("diarist did not create laser.pew")
